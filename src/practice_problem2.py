...
def run_test_practice_problem2a():
    ...
    expected = [6, 7, 8, 9, 10]
    actual = practice_problem2a(sequence1, delta1)
    print('Test 1')
    print(expected)
    print(actual)
    ...
    expected = [8, 10, 6, 3]
    actual = practice_problem2a(sequence2, delta2)
    print('Test 2')
    print(expected)
    print(actual)
    ...
    expected = [5, 2, 6, 1]
    actual = practice_problem2a(sequence3, delta3)
    print('Test 3')
    print(expected)
    print(actual)
    ...
    expected = []
    actual = practice_problem2a(sequence4, delta4)
    print('Test 4')
    print(expected)
    print(actual)
...
def practice_problem2b(sequence):
    ...
    for i in range(len(sequence)):
        ...
        if len(word) > 0:
            first_letter = word[0]
            str_to_return = str_to_return + first_letter
